// Firebase Web configuration for MunichPulse (Web)
// HOW TO USE:
// 1) Go to Firebase Console → Project settings → Your apps → Web app
// 2) Click "Config" to get the SDK config and paste it below as the object literal.
// 3) Keep this file in composeApp/src/webMain/resources so it is served with the web build.
